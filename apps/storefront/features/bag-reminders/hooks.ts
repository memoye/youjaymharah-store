...
import type { StoreStopBagRemindersResponse } from "@youjaymharah/api-types"
 ...
 */
export function useStopBagReminders() {
  return useMutation({
    mutationFn: (token: string) =>
      getBrowserSdk().client.fetch<StoreStopBagRemindersResponse>(
        "/store/bag-reminders/stop",
