 ...
 *
 * This lives in migration-scripts so `medusa db:migrate` recreates the exact
 * same roles in dev, staging and production. Building them by hand in the
 * admin would leave each environment to drift.
 *
