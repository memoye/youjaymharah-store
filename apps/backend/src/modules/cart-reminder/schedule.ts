...
/**
 * Which reminder, if any, is due for a cart.
 *
 * Each reminder is due its delay after the cart's last change, so a shopper
 * who comes back and edits the cart pushes the next reminder out. When several
...
/**
 * The range of last-change times worth looking at: carts changed too recently
 * for the first reminder are skipped, and carts too old for even the last one
