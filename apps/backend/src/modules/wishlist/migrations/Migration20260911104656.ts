...
export class Migration20260911104656 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`CREATE INDEX IF NOT EXISTS "IDX_wishlist_item_wishlist_id_product_id" ON "wishlist_item" ("wishlist_id", "product_id") WHERE deleted_at IS NULL;`);
